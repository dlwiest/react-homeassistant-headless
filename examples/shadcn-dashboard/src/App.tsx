      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="lighting" className="w-full">
          ...
          <TabsContent value="lighting" className="space-y-6">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">Scenes</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <TabsContent value="productivity" className="space-y-6">
            <section>
              <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">Vacuum Cleaners</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <section>
              <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">Calendar</h2>
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
